...
const ShippingScreen = () => {
  ...
  const { userInfo } = useSelector((state) => state.auth); // Pull user profile data

  // Auto-fill logic: Cart State -> Saved User Profile State -> Empty String
          ...
          <form onSubmit={submitHandler}>
            ...
            <div style={styles.inputGroup}>
              ...
              <input
                ...
                style={{ ...styles.input, border: '1px solid #28a745' }}
              />
...
const styles = {
  container: { display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh', backgroundColor: '#f5f5f5', padding: '20px' },
  card: { backgroundColor: 'white', padding: '40px', borderRadius: '10px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', width: '100%', maxWidth: '550px' },
  stepsContainer: { display: 'flex', justifyContent: 'center', marginBottom: '25px', fontSize: '0.9rem', fontWeight: '600', color: '#888' },
  activeStep: { color: 'black', borderBottom: '2px solid black', paddingBottom: '2px' },
  inactiveStep: { color: '#ccc' },
  stepDivider: { margin: '0 10px', color: '#ccc' },
  title: { textAlign: 'center', marginBottom: '10px', fontSize: '1.8rem', color: '#333' },
  subtitle: { textAlign: 'center', marginBottom: '30px', color: '#666' },
  inputGroup: { marginBottom: '20px' },
  row: { display: 'flex', gap: '15px' },
  label: { display: 'block', marginBottom: '8px', fontWeight: '600', color: '#333', fontSize: '0.95rem' },
  input: { width: '100%', padding: '12px 15px', borderRadius: '6px', border: '1px solid #ddd', fontSize: '1rem', transition: 'border-color 0.2s', outline: 'none' },
  button: { width: '100%', padding: '14px', backgroundColor: 'black', color: 'white', border: 'none', borderRadius: '6px', fontSize: '1rem', cursor: 'pointer', fontWeight: 'bold', marginTop: '10px', transition: 'opacity 0.2s' },
};
