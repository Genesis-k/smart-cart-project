...
// (keep in sync with PAYPAL_ENABLED in OrderScreen.jsx).
    ...
    <>
      ...
      <div style={{ maxWidth: '500px', margin: '0 auto', padding: '20px' }}>
        ...
        <form onSubmit={submitHandler}>
          ...
          {/* PayPal / Card Option - hidden until tested. Uncomment the block below
              and flip PAYPAL_ENABLED to true to bring it back.
          {PAYPAL_ENABLED && (
          ...
          */}
          ...
          <button
              type="submit"
              className="btn-black"
              style={{ padding: '15px', width: '100%', background: 'black', color: 'white', border: 'none', cursor: 'pointer', fontSize: '1.1rem', marginTop: '5px' }}
          >
            Continue
          </button>
        </form>
